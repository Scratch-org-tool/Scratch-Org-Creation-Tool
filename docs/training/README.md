...
The Salesforce Academy currently ships **8 learning paths, 25 modules, and 75 lessons**. Every lesson below has a complete concept explanation, a real-world example, and a timecoded **5-minute video script** (word-for-word narration, on-screen direction, and demo steps).
...
| Modern Salesforce Platform | Intermediate | Salesforce core curriculum | 3 | 6 | [sf-modern-platform.md](./sf-modern-platform.md) |
