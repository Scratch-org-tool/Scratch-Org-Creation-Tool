/**
 * Load-test: 10k manifest parse + plan. Run after build:
 *   node packages/metadata-orchestrator/scripts/load-test-plan.mjs
 */
...
function generateLargeManifest(memberCount) {
